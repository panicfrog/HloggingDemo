...
private extension RustBuffer {
    ...
    init(bytes: [UInt8]) {
        let rbuf = bytes.withUnsafeBufferPointer { ptr in
            try! rustCall { ffi_hlogging_d3ee_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
        }
    ...
    func deallocate() {
        try! rustCall { ffi_hlogging_d3ee_rustbuffer_free(self, $0) }
    }
}
...
extension String: ViaFfi {
    ...
    fileprivate static func lift(_ v: FfiType) throws -> Self {
        defer {
            try! rustCall { ffi_hlogging_d3ee_rustbuffer_free(v, $0) }
        }
        if v.data == nil {
            return String()
        }
    ...
    fileprivate func lower() -> FfiType {
        return utf8CString.withUnsafeBufferPointer { ptr in
            ...
            ptr.withMemoryRebound(to: UInt8.self) { ptr in
                ...
                return try! rustCall { ffi_hlogging_d3ee_rustbuffer_from_bytes(bytes, $0) }
            }
        }
    }
...
public func writeFile(filename: String, message: String) throws {
    try
        ...
        rustCallWithError(WriteFileError.self) {
            hlogging_d3ee_write_file(filename.lower(), message.lower(), $0)
        }
}
...
public func configure(label: String, level: LoggingLevel, loggerType: HLoggingType) {
    try!
        ...
        rustCall {
            hlogging_d3ee_configure(label.lower(), level.lower(), loggerType.lower(), $0)
        }
}
...
public func debug(metadata: Metadata, message: String, source: String?) {
    try!
        ...
        rustCall {
            hlogging_d3ee_debug(metadata.lower(), message.lower(), source.lower(), $0)
        }
}
...
public func info(metadata: Metadata, message: String, source: String?) {
    try!
        ...
        rustCall {
            hlogging_d3ee_info(metadata.lower(), message.lower(), source.lower(), $0)
        }
}
...
public func notice(metadata: Metadata, message: String, source: String?) {
    try!
        ...
        rustCall {
            hlogging_d3ee_notice(metadata.lower(), message.lower(), source.lower(), $0)
        }
}
...
public func warring(metadata: Metadata, message: String, source: String?) {
    try!
        ...
        rustCall {
            hlogging_d3ee_warring(metadata.lower(), message.lower(), source.lower(), $0)
        }
}
...
public func error(metadata: Metadata, message: String, source: String?) {
    try!
        ...
        rustCall {
            hlogging_d3ee_error(metadata.lower(), message.lower(), source.lower(), $0)
        }
}
...
public func critical(metadata: Metadata, message: String, source: String?) {
    try!
        ...
        rustCall {
            hlogging_d3ee_critical(metadata.lower(), message.lower(), source.lower(), $0)
        }
}
